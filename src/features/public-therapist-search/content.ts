...
export const fallbackTherapists: TherapistSearchCard[] = [
  {
    ...
    reviewCount: 98,
    serviceTitle: "Sessão integrativa de acolhimento",
    slug: "ana-oliveira",
  ...
  },
  {
    ...
    reviewCount: 74,
    serviceTitle: "Sessão para mudanças de vida",
    slug: "rafael-santos",
  ...
  },
  {
    ...
    reviewCount: 112,
    serviceTitle: "Sessão de escuta integrativa",
    slug: "celia-martins",
    tags: ["Relacionamentos", "Luto", "Autoestima"],
    themeSlugs: ["autoconhecimento", "equilibrio-emocional"],
    therapyName: "Terapia Floral",
    therapySlug: "terapia-floral",
  },
  {
    availabilityBucket: "week",
    ...
    reviewCount: 88,
    serviceTitle: "Sessão de comunicação e vínculos",
    slug: "juliana-costa",
  ...
  },
  {
    ...
    reviewCount: 101,
    serviceTitle: "Sessão de presença e escolhas",
    slug: "lucas-pereira",
    tags: ["Autoconhecimento", "Propósito", "Mudanças de vida"],
    themeSlugs: ["autoconhecimento", "mudancas-de-vida"],
    therapyName: "Meditação Guiada",
    therapySlug: "meditacao-guiada",
  },
];
