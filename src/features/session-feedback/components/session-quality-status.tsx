...
export function SessionQualityStatus({ payload, actorRole }: {
  ...
  return (
    <section aria-label="Realização e qualidade da sessão" className="grid gap-2 rounded-card border border-brand-lavender bg-white p-5 text-sm font-semibold leading-6">
      ...
      {review?.isOpen ? <p>{review.overdue
        ...
        : "Seu relato foi encaminhado ao Suporte TES. A equipe responderá em até 5 dias corridos."}</p> : null}
