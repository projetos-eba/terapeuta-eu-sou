  ...
  return (
    <section className="max-h-none overflow-visible rounded-[22px] border border-brand-lavender bg-white p-6 shadow-card sm:p-7 lg:max-h-[620px] lg:overflow-y-auto">
      <div className="flex items-center justify-between gap-4">
        ...
        {staticPreview ? (
          <span className="inline-flex min-h-11 items-center gap-1.5 rounded-full border border-brand-lavender px-4 py-2 text-sm font-semibold text-brand-primary">
          ...
          <button
            ...
            className="inline-flex min-h-11 items-center gap-1.5 rounded-full border border-brand-lavender px-4 py-2 text-sm font-semibold text-brand-primary transition hover:bg-brand-lavenderSoft focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-primary"
      ...
      {count === 0 ? (
        ...
        <>
          ...
          <div className="mt-5 grid gap-5 md:grid-cols-2" id="reviews-list">
            {(showAllReviews && !staticPreview ? reviews : visibleReviews).map(
              (review) => (
                <article
                  key={review.id}
                ...
                >
                  ...
                  {review.reply ? (
                    <div className="mt-4 rounded-2xl bg-brand-lavenderSoft/70 p-4">
                      ...
                      <p
                        className={`mt-2 text-sm font-medium leading-6 text-tesText-secondary ${
                          expandedReplies[review.id] ? "" : "line-clamp-2"
                        }`}
          ...
          {!staticPreview && pages.length > 1 && !showAllReviews ? (
            <nav
            ...
            >
              <button
                ...
                className="grid size-11 place-items-center rounded-full text-brand-primary transition hover:bg-brand-lavenderSoft disabled:cursor-not-allowed disabled:opacity-35"
                disabled={page === 0}
              ...
              {pages.map((_, index) => (
                <button
                  ...
                  className="grid size-11 place-items-center rounded-full transition hover:bg-brand-lavenderSoft focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-primary"
