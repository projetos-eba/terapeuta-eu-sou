  ...
  public: {
    Tables: {
      ...
      booking_session_attempts: {
        ...
        Relationships: [
          {
            foreignKeyName: "booking_session_attempts_booking_id_fkey"
            columns: ["booking_id"]
            isOneToOne: false
            referencedRelation: "bookings"
            referencedColumns: ["id"]
      ...
      financial_reconciliation_runs: {
        Row: {
          ...
          payouts_reconciled: number
          scheduled_for: string
          settlements_reconciled: number
          source_charges_reconciled: number
          status: string
          transfers_reconciled: number
          updated_at: string
          worker_id: string
        }
        Insert: {
      ...
      session_confirmation_incidents: {
        Row: {
          ...
          operational_resolution: string | null
          patient_arrived_at: string | null
          patient_joined_at: string | null
          policy_version_id: string | null
          processing_cost_recovery_authorized: boolean
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "session_confirmation_incidents_policy_version_id_fkey"
            columns: ["policy_version_id"]
            isOneToOne: false
            referencedRelation: "financial_policy_versions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "session_confirmation_incidents_session_attempt_id_fkey"
            columns: ["session_attempt_id"]
            isOneToOne: false
            referencedRelation: "booking_session_attempts"
            referencedColumns: ["id"]
          },
          {
      ...
      session_participant_confirmations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "session_participant_confirmations_session_attempt_id_fkey"
            columns: ["session_attempt_id"]
            isOneToOne: false
            referencedRelation: "booking_session_attempts"
            referencedColumns: ["id"]
      ...
      session_quality_feedback: {
        ...
        Relationships: [
          {
            foreignKeyName: "session_quality_feedback_author_profile_id_fkey"
            columns: ["author_profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "session_quality_feedback_booking_id_fkey"
            columns: ["booking_id"]
            isOneToOne: false
            referencedRelation: "bookings"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "session_quality_feedback_session_attempt_id_fkey"
            columns: ["session_attempt_id"]
            isOneToOne: false
            referencedRelation: "booking_session_attempts"
            referencedColumns: ["id"]
      ...
      session_quality_reviews: {
        ...
        Relationships: [
          {
            foreignKeyName: "session_quality_reviews_feedback_id_fkey"
            columns: ["feedback_id"]
            isOneToOne: true
            referencedRelation: "session_quality_feedback"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "session_quality_reviews_requester_profile_id_fkey"
          ...
          {
            foreignKeyName: "session_quality_reviews_response_message_id_fkey"
          ...
          {
            foreignKeyName: "session_quality_reviews_session_attempt_id_fkey"
            columns: ["session_attempt_id"]
            isOneToOne: false
            referencedRelation: "booking_session_attempts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "session_quality_reviews_ticket_id_fkey"
            columns: ["ticket_id"]
            isOneToOne: true
      ...
      session_refund_decisions_v10: {
        Row: {
          ...
          id: string
          reason: string
          recovery_reconciled_at: string | null
          ...
          stripe_transfer_id: string | null
          therapist_exposure_cents: number
          updated_at: string
        }
        Insert: {
          actor_user_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "session_refund_decisions_v10_actor_user_id_fkey"
            columns: ["actor_user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "session_refund_decisions_v10_session_payment_id_fkey"
            columns: ["session_payment_id"]
            isOneToOne: true
            referencedRelation: "private_direct_transfer_session_payments_v1"
            referencedColumns: ["id"]
      ...
      session_refund_incidents_v10: {
        Row: {
          ...
          resolved_at: string | null
          session_refund_decision_id: string
        }
        Insert: {
          code: string
          created_at?: string
        ...
        Relationships: [
          {
            foreignKeyName: "session_refund_incidents_v10_session_refund_decision_id_fkey"
            columns: ["session_refund_decision_id"]
            isOneToOne: false
            referencedRelation: "session_refund_decisions_v10"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      therapist_financial_debts: {
        ...
        Relationships: [
          {
            foreignKeyName: "therapist_financial_debts_session_confirmation_incident_id_fkey"
            columns: ["session_confirmation_incident_id"]
            isOneToOne: false
            referencedRelation: "session_confirmation_incidents"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "therapist_financial_debts_session_confirmation_incident_id_fkey"
      ...
      therapist_schedule_events: {
        Row: {
          ...
          event_type: string
          id: string
          previous_active_rule_count: number | null
      ...
      therapist_verifications: {
        Row: {
          ...
          restore_publication_on_approval: boolean
          review_origin: string
          reviewed_at: string | null
          reviewed_by: string | null
          source_connect_account_id: string | null
          source_schedule_event_id: string | null
          source_stripe_event_id: string | null
          status: Database["public"]["Enums"]["therapist_status"]
          submitted_at: string
          therapist_profile_id: string
          updated_at: string
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "therapist_verifications_source_connect_account_id_fkey"
            columns: ["source_connect_account_id"]
            isOneToOne: false
            referencedRelation: "therapist_connect_accounts"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "therapist_verifications_source_schedule_event_id_fkey"
            columns: ["source_schedule_event_id"]
            isOneToOne: false
            referencedRelation: "therapist_schedule_events"
            referencedColumns: ["id"]
          },
          {
      ...
      video_session_participations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "video_session_participations_session_attempt_id_fkey"
            columns: ["session_attempt_id"]
            isOneToOne: false
            referencedRelation: "booking_session_attempts"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      admin_get_full_session_refund_followup_v10: {
        Args: { p_session_payment_id: string }
        Returns: Json
      }
      admin_get_full_session_refund_status_v11: {
        Args: { p_session_payment_id: string }
        Returns: Json
      }
      ...
      admin_resolve_session_attendance_v1: {
        Args: {
      ...
      cancel_therapist_uncharged_session_v10: {
        Args: {
          p_booking_id: string
          p_reason: string
          p_request_id: string
          p_therapist_user_id: string
        }
        Returns: Json
      }
      ...
      claim_full_session_refund_v10_v2: {
        Args: {
          p_actor_user_id: string
          p_reason: string
          p_request_id: string
      ...
      claim_full_session_refund_v10_v3: {
        Args: {
          p_actor_user_id: string
          p_reason: string
          p_request_id: string
      ...
      complete_therapist_change_refund_v1: {
        Args: {
          p_actor_user_id: string
          p_request_id: string
          p_session_payment_id: string
      ...
      finalize_attendance_refund_financials_v1: {
        Args: { p_session_payment_id: string }
        Returns: Json
      }
      ...
      finalize_financial_reconciliation_run_v1: {
        Args: {
          p_last_error?: string
          p_payouts_reconciled?: number
          p_run_id: string
          p_settlements_reconciled?: number
          p_source_charges_reconciled?: number
          p_status: string
          p_transfers_reconciled?: number
          p_worker_id: string
        }
        Returns: undefined
      }
      ...
      get_therapist_attendance_recurrence_v1: {
        Args: { p_now?: string; p_therapist_profile_id: string }
        Returns: Json
      }
      ...
      get_therapist_calendar_range_v1: {
      ...
      get_therapist_schedule_v1_before_completion_gate: {
        Args: never
        Returns: Json
      }
      ...
      private_get_therapist_reviews_v1_legacy: { Args: never; Returns: Json }
      private_patient_session_feedback_queue_v1_v9_legacy: {
        Args: never
        Returns: Json
      }
      ...
      private_therapist_payouts_v2_v10_gross_processing_legacy: {
        Args: {
          p_page?: number
          p_page_size?: number
          p_period_end?: string
      ...
      private_therapist_payouts_v2_v9_history_legacy: {
        Args: {
          p_page?: number
          p_page_size?: number
          p_period_end?: string
      ...
      private_therapist_receipts_monthly_trend_v2: {
        Args: {
          p_period_end: string
          p_period_start: string
          p_search: string
      ...
      private_therapist_receipts_v2_legacy_timezone: {
        Args: {
          p_page?: number
          p_page_size?: number
          p_period_end?: string
      ...
      reconcile_full_session_refund_debt_v10: {
        Args: { p_session_payment_id: string }
        Returns: Json
      }
      ...
      reconcile_session_refund_event_v10: {
        Args: {
      ...
      reconcile_session_transfer_reversal_v10: {
        Args: {
          p_amount_cents: number
          p_currency: string
          p_occurred_at: string
      ...
      record_session_payment_stripe_reconciliation_v2: {
        Args: {
          p_balance_amount_cents?: number
          p_balance_available_on?: string
          p_balance_currency?: string
          p_balance_source_charge_id?: string
          p_balance_status?: string
          p_payment_method_type?: string
          p_payment_origin?: string
          p_receipt_url?: string
          p_session_payment_id: string
      ...
      save_therapist_schedule_v1_before_completion_gate: {
        Args: {
          p_actor_user_id: string
          p_expected_version: number
          p_request_id: string
      ...
      send_session_delay_notice_v1: {
        Args: { p_booking_id: string; p_expected_booking_version: number }
        Returns: Json
      }
      ...
      session_quality_feedback_payload_v1: {
        Args: {
          p_feedback: Database["public"]["Tables"]["session_quality_feedback"]["Row"]
        }
        Returns: Json
      }
      ...
      transition_full_session_refund_step_v10: {
        Args: { p_decision_id: string; p_state: string; p_step: string }
        Returns: Json
      }
      ...
      withdraw_therapist_booking_reschedule_v10: {
        Args: {
          p_expected_booking_version?: number
          p_request_id: string
          p_reschedule_request_id: string
