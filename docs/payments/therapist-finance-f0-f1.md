...
`get_private_therapist_payouts_v5` são projeções aditivas, privadas e somente
...
V5 preserva a agenda de V4 e usa `arrival_at` como data de recebimento bancário
quando a Stripe a fornece, mantendo `paid_at` apenas como fallback.
...
| A receber                 | Valores previstos na janela de 7, 15 ou 30 dias, mais repasses sem data bancária.                                                            | `get_private_therapist_payouts_v5.summary.expectedCents`                                              | R$ 0,00.                                               | `operation_essentials` |
| A caminho da sua conta    | Valores que já iniciaram o processo efetivo de depósito.                                                                                     | `get_private_therapist_payouts_v5.summary.inTransitCents`                                             | R$ 0,00.                                               | `operation_essentials` |
| Recebido                  | Chegada bancária confirmada no período histórico.                                                                                            | `get_private_therapist_payouts_v5.summary.receivedCents`                                              | R$ 0,00.                                               | `operation_essentials` |
...
| Agenda de repasses        | Depósito em andamento, chegada prevista, disponibilidade do saldo e valores sem data bancária; nunca confundir disponibilidade com depósito. | `get_private_therapist_payouts_v5.agenda`                                                             | Nenhum repasse previsto.                               | `operation_essentials` |
| Histórico de repasses     | Valores recebidos e exceções discretas em análise.                                                                                           | `get_private_therapist_payouts_v5.historyItems`                                                       | Nenhum valor recebido no período.                      | `operation_essentials` |
