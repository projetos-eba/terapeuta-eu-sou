...
`get_private_therapist_payouts_v3` são projeções aditivas, privadas e somente
...
| A receber                 | Valores com data de chegada confiável na janela de 7, 15 ou 30 dias.             | `get_private_therapist_payouts_v3.summary.expectedCents`                                               | R$ 0,00.                                               | `operation_essentials` |
| A caminho da sua conta    | Valores que já iniciaram o processo efetivo de depósito.                         | `get_private_therapist_payouts_v3.summary.inTransitCents`                                              | R$ 0,00.                                               | `operation_essentials` |
| Recebido                  | Chegada bancária confirmada no período histórico.                                | `get_private_therapist_payouts_v3.summary.receivedCents`                                               | R$ 0,00.                                               | `operation_essentials` |
...
| Agenda de repasses        | Futuro agrupado por data, primeiro a caminho e depois previsto.                  | `get_private_therapist_payouts_v3.agenda`                                                             | Sem data de chegada disponível.                        | `operation_essentials` |
| Histórico de repasses     | Valores recebidos e exceções discretas em análise.                               | `get_private_therapist_payouts_v3.historyItems`                                                       | Nenhum valor recebido no período.                      | `operation_essentials` |
