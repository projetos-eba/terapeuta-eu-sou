...
-- Attendance classification remains fully auditable.  This only replaces
-- participant-facing copy, keeping financial implementation details out of
-- notifications and session screens.
...
set body = 'O TES está analisando o ocorrido e avisará você sobre o resultado. Se precisar, entre em contato com nosso suporte.'
