  ...
  loop
    ...
    values
      (
        ...
        case when v_class = 'no_show_both'
          then 'O TES está analisando o que ocorreu nesta sala. Se tiver alguma dúvida, entre em contato com o TES.'
          else 'O TES analisará o registro em até 5 dias. Qualquer decisão financeira exige autorização do Admin.'
        end,
      ...
      (
        ...
        case when v_class = 'no_show_both'
          then 'O TES está analisando o que ocorreu nesta sala. Se tiver alguma dúvida, entre em contato com o TES.'
          else 'O TES analisará o registro em até 5 dias. O financeiro permanece separado desta classificação.'
        end,
